...
<br>
 ...
 <br>
 <label class="w3-text-teal" style="font-weight: bold;">Nota 1º módulo</label>
 <input name="txtMod1" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['nota1']?>">
 <br>
 <label class="w3-text-teal" style="font-weight: bold;">Nota 2º módulo</label>
 <input name="txtMod2" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['nota2']?>">
 <br>
 <label class="w3-text-teal" style="font-weight: bold;">Nota 3º módulo</label>
 <input name="txtMod3" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['nota3']?>">
 <br>
 <label class="w3-text-teal" style="font-weight: bold;">Nota 4º módulo</label>
 <input name="txtMod4" class="w3-input w3-border w3-grey" disabled value="<?php echo $_GET['nota4']?>">
 <br>
